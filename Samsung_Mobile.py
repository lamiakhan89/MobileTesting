...
@pytest.fixture(scope="session", autouse=True)
def auto_start(request, onstream_version, onstream_url, client_setup,influxdb_bucket,influxdb_org):
    try:
...
def setup(request, onstream_url, custom_logo,mobile_platform,mobile_device_id):
    ...
    if mobile_device_id=='RF8M418S1AB':
        pass
    else:
        assert False, 'wrong_mobile_device_id'
...
class TestVersion:
    def test_app_version(self, onstream_version, onstream_url, influxdb_bucket, influxdb_org,client_setup):
        try:
            WebDriverWait(self.driver, 200).until(ec.presence_of_element_located(
                (By.XPATH, UI_Constant.home_button)))  # Wait for the Home Page to Load fully
            time.sleep(5)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="HEADER_CONTAINER"]/div[2]/nav/div/button[5]').click()  # settings
            time.sleep(3)
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div[1]/div/button[3]').click()  # legal
            time.sleep(5)
            v = self.driver.find_element(By.XPATH,
                                         '//*[@class="_2hnwQ2hn8tcdObPRmB_t2G"]')  # Find the Application Version text
            v = v.text.split('\n')[1].strip()
            mylogger.info(v)
...
class TestHomeScreen:
    def test_hero_screen(self, onstream_version, onstream_url, influxdb_bucket, influxdb_org,client_setup):
        try:
            ...
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located((By.XPATH,
                                                                                 '//*[@id="HERO_CAROUSEL_CONTAINER"]/div/div/div/div[2]/div/div/div/div/div/div/button'))).click()  # learn more
            time.sleep(5)
            ...
            time.sleep(3)
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located((By.XPATH,
                                                                                 '//*[@id="HERO_CAROUSEL_CONTAINER"]/div/div/div/div[3]/div/div/div/div/div/div/button'))).click()  # learn more
            time.sleep(2)
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div[5]/div/div[1]/img').click()  # close button
            time.sleep(2)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="HEADER_CONTAINER"]/div[1]/img').is_displayed()  # onstream  logo is displayed
            self.driver.find_element(By.XPATH,
                                     '//*[@id="HERO_CAROUSEL_CONTAINER"]/div/div/div/div[2]/div/div/div/div/div/div/div/div[2]/div[1]').is_displayed()  # second line of text
            self.driver.find_element(By.XPATH,
                                     '//*[@id="HERO_CAROUSEL_CONTAINER"]/div/div/div/div[2]/div/div/div/div/div/div/div/div[2]/div[1]').is_displayed()  # hero screen description
    ...
    def test_featured_channels(self, onstream_version, onstream_url, influxdb_bucket, influxdb_org,client_setup):
        try:
            ...
            time.sleep(3)
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div[1]/div/div[1]/div[2]/div[2]/div/div/div[2]/div[1]/div[1]/button').click()  # more button
            time.sleep(5)
            self.driver.find_element(By.XPATH,'//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div[1]/div/div/div[1]/button').click()  # play first video
            time.sleep(10)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="PLAYER_CLOSE_BTN"]').click()  # close button
            time.sleep(2)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div[2]/div/div/div[2]/div[1]/div[1]/button').click()  #second video
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div[2]/div/div/div[2]/div[1]/div[1]/button').click()  # more button
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div[2]/div/div/div[2]/div[1]/div[1]/button').click()  # more button
            ...
            ##time.sleep(5)
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located((By.XPATH,
                                                                                 '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div/div[2]/div[1]/div[2]/div[2]/div/div/div[1]/div/div/div/div/div/div[3]/div[3]/h3'))).click()  # 1st box
            time.sleep(2)
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located(
                (By.XPATH, '/html/body/div[5]/div[3]/div/div/div/div[3]/button'))).click()  # watch now
            time.sleep(2)
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located(
                (By.XPATH, '//*[@id="dish-bitmovin-player"]/div[3]/div/div[1]/div[3]'))).click()  # click space
            time.sleep(2)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="dish-bitmovin-player"]/div[3]/div/div[2]/div[3]/button').click()  # mini guide
            time.sleep(2)
            ...
            self.driver.find_element(By.XPATH,
                                     '//*[@id="WATCH_NOW_BUTTON"]/img').click()  # play video on one of the channels
            time.sleep(2)
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located(
                (By.XPATH, '//*[@id="dish-bitmovin-player"]/div[3]/div/div[2]/div[1]/button'))).click()  # volume bar
            time.sleep(2)
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located(
                (By.XPATH, '//*[@id="dish-bitmovin-player"]/div[3]/div/div[2]/div[2]/button'))).click()  # caption click
            WebDriverWait(self.driver, 60).until(
                ec.presence_of_element_located((By.XPATH, '//*[@id="subtitle-popper"]/ul/div[3]'))).click()  # english
            time.sleep(5)
            self.driver.find_element(By.XPATH, '//*[@id="PLAYER_CLOSE_BTN"]/img').click()  # close button
            time.sleep(5)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="HEADER_CONTAINER"]/div[2]/nav/div/button[1]').click()  # home button
            time.sleep(5)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div/div[2]/div[1]/div[2]/div[2]/div/div/div[3]/div/div/div/div/div/div[3]/div[3]/h3').click()  # play third video space
            time.sleep(4)
            self.driver.find_element(By.XPATH,
                                     '/html/body/div[5]/div[3]/div/div/div/div[3]/button').click()  # watch now
            time.sleep(20)
            self.driver.find_element(By.XPATH, '//*[@id="PLAYER_CLOSE_BTN"]/img').click()  # close button
            time.sleep(4)
            self.driver.find_element(By.XPATH,
            ...
            self.driver.find_element(By.XPATH,
                                     '//*[@id="ITEM_SWIMLANE_INNER_CONTAINER_0_0"]/div/div[3]/div[3]/h3').is_displayed()  ## check title
            self.driver.find_element(By.XPATH,
                                     '//*[@id="ITEM_SWIMLANE_INNER_CONTAINER_0_0"]/div/div[3]/div[3]/h2[2]').is_displayed()  # check LIVE written and time remaining
            self.driver.find_element(By.XPATH,
                                     '//*[@id="ITEM_SWIMLANE_INNER_CONTAINER_0_1"]/div/div[2]/span').is_displayed()  # live button
            '''
    ...
    def test_sports(self, onstream_version, onstream_url, influxdb_bucket, influxdb_org,client_setup):
        try:
            WebDriverWait(self.driver, 60).until(
                ec.presence_of_element_located((By.XPATH, UI_Constant.home_button)))  # Wait for the Home Page to Load
            time.sleep(5)
            spb = self.driver.find_element(By.XPATH,
                                           '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div/div[2]/div[2]/div[2]/div[2]/div/div/div/div/div/div/div/div/img')
            time.sleep(3)
            ...
            WebDriverWait(self.driver, 80).until(ec.presence_of_element_located((By.XPATH,
                                                                                 '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div/div[2]/div[2]/div[2]/div[2]/div/div/div/div/div/div/div/div/img'))).click()  # sportsclick
            self.driver.set_window_size(1700, 971)
            time.sleep(15)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div/div/div[2]/div[2]/div[1]/button').click()  # nba right arrow
            time.sleep(2)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div/div/div[2]/div[2]/div[1]/button[1]').click()  # nba left arrow
            time.sleep(2)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div/div/div[2]/div[2]/div[2]/div/div/div[1]/div/div/div/div/div').click()  # NBA Click
            time.sleep(5)
            self.driver.find_element(By.XPATH, '/html/body/div[5]/div[3]/div/div[1]/button').click()  # x arrow
            time.sleep(5)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div/div/div[1]/div[2]/div[2]/div/div/div/div/div/div/div/div').click()  # nfl
            time.sleep(5)
            self.driver.find_element(By.XPATH, '/html/body/div[5]/div[3]/div/div[1]/button').click()  # x nfl
            time.sleep(10)
            nhl = self.driver.find_element(By.XPATH,
                                           '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div/div/div[3]/div[2]/div[2]/div/div/div[1]')
            self.driver.execute_script('arguments[0].scrollIntoView(true);', nhl)  # Scroll Down to the Bottom
            time.sleep(10)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div/div/div[3]/div[2]/div[2]/div/div/div[1]').click()  # nhl click
            time.sleep(5)
            self.driver.find_element(By.XPATH, '/html/body/div[5]/div[3]/div/div[1]/button').click()  # x nhl
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div/div/div[3]/div[2]/div[1]/button').click()  # nhl  right arrow
            time.sleep(2)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div/div/div[3]/div[2]/div[1]/button[1]').click()  # nhl  left arrow
            time.sleep(4)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="HEADER_CONTAINER"]/div[2]/nav/div/button[1]').click()  # x homepage click
            time.sleep(5)
            self.driver.find_element(By.XPATH,
...
class TestGuide:
    def test_modern_guide(self, onstream_version, onstream_url, influxdb_bucket, influxdb_org,client_setup):
        try:
            ...
            for i in range(len(play_buttons)):
                try:
                    WebDriverWait(self.driver, 60).until(ec.visibility_of_element_located((By.XPATH,
                    ...
                    time.sleep(3)
                    WebDriverWait(self.driver, 60).until(ec.presence_of_element_located(
                        (By.XPATH, '//*[@id="dish-bitmovin-player"]/div[3]/div'))).click()  # click space
                    time.sleep(2)
            ...
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div[2]/div[2]/button[2]/span[1]') #root left to remove
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div[2]/div[1]') #left logo reach
            time.sleep(4)
            self.driver.find_element(By.XPATH, '//*[@id="HEADER_CONTAINER"]/div[2]/nav/div/button[4]') #remove time sleep
            time.sleep(6)
            self.driver.find_element(By.XPATH, '//*[@id="header-section"]') # remove top left
    ...
    def test_classic_guide(self, onstream_version, onstream_url, influxdb_bucket, influxdb_org,client_setup):
        try:
            ...
            time.sleep(3)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="HEADER_CONTAINER"]/div[2]/nav/div/button[5]').click()  # settings new
            time.sleep(3)
            WebDriverWait(self.driver, 60).until(
            ...
            play_buttons = self.driver.find_elements(By.XPATH,
                                                     '//*[@class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-m9dfmo"]')  # play video
            mylogger.info(play_buttons)
            time.sleep(10)
            ...
            for i in range(len(play_buttons)):  ## start loops
                try:
                    ...
                    self.driver.find_elements(By.XPATH,
                                              '//*[@class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-m9dfmo"]')[
                        i].click()
                    ...
                    mylogger.error("failed channel number {}".format(i))
                    WebDriverWait(self.driver, 60).until(
                        ec.presence_of_element_located((By.XPATH, UI_Constant.tv_guide))).click()
...
class TestDemand:
    def test_on_demand(self, onstream_version, onstream_url, influxdb_bucket, influxdb_org,client_setup):
        try:
            ...
            time.sleep(3)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="HEADER_CONTAINER"]/div[2]/nav/div/button[3]').click()  # On demand button
            time.sleep(7)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div[1]/div[2]/div[1]/button').click()  # right arow trending content
            time.sleep(7)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div[1]/div[2]/div[1]/button').click()  # left arrow trending contenet
            time.sleep(7)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div[1]/div[2]/div[2]/div/div/div[6]').click()  # cobrakai
            time.sleep(15)
            self.driver.find_element(By.XPATH,
                                     '/html/body/div[5]/div[3]/div/div/div/div[3]/div[1]/button').click()  # play button
            time.sleep(5)
            ...
            time.sleep(4)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div[2]/div[2]/div[1]/button').click()  # right button popular shows
            time.sleep(5)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div[2]/div[2]/div[2]/div/div/div[10]/div/div/div/div/div').click()  # see all
            time.sleep(2)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div[2]/div/div').click()  # hawkeye
            time.sleep(15)
            self.driver.find_element(By.XPATH,
                                     '/html/body/div[5]/div[3]/div/div/div/div[3]/div[1]/button').click()  # play button
            time.sleep(5)
...
class TestSearch:
    def test_search_button(self, onstream_version, onstream_url, influxdb_bucket, influxdb_org,client_setup):
        try:
            ...
            time.sleep(3)
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located(
                (By.XPATH, UI_Constant.search_button))).click()  # wait for search to load
            time.sleep(5)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div[1]/div/input').send_keys(
                'Court Cam')  # search box
            ##self.driver.find_element(By.XPATH,UI_Constant.search_button).send_keys('Court Cam')  # serching for program
            time.sleep(3)

            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div[3]/div[2]/div/div[1]/div/div').click()  # on demand program
            time.sleep(7)
            self.driver.find_element(By.XPATH,
            ...
            time.sleep(5)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div[2]/div[1]/button').click()  # clear all
            time.sleep(5)
            self.driver.find_element(By.XPATH,
...
class TestSettings:
    def test_settings(self, onstream_version, onstream_url, influxdb_bucket, influxdb_org,client_setup):
        try:
            ...
            time.sleep(3)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div[2]/div/div/div[5]/button[1]/div[2]/div/label/div').click()  # Enable large font size
            time.sleep(3)
            WebDriverWait(self.driver, 60).until(
                ec.presence_of_element_located((By.XPATH, UI_Constant.tv_guide))).click()  # tv guide
            time.sleep(3)
            ...
            time.sleep(3)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div[1]/div/div[1]/div[2]/div/div/div[2]/div/div/div[5]/button[2]/div[2]/img').click()  # 24 hour
            time.sleep(2)
            WebDriverWait(self.driver, 60).until(
                ec.presence_of_element_located((By.XPATH, UI_Constant.tv_guide))).click()  # tv guide
            time.sleep(3)
