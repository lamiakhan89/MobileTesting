...
class TestHomeScreen:
    def test_hero_screen(self, onstream_version, onstream_url, client_setup):
        try:
            ...
            time.sleep(5)
            self.driver.find_element(By.XPATH, '//*[@id="HERO_CAROUSEL_CONTAINER"]/div/ul/li[5]/button').click()  # fifth button click
            time.sleep(5)
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located((By.XPATH, '//*[@id="HERO_CAROUSEL_CONTAINER"]/div/ul/li[1]/button'))).click()  # 1st button click
            time.sleep(5)
            self.driver.find_element(By.XPATH, '//*[@id="HERO_CAROUSEL_CONTAINER"]/div/div/div/div[2]/div/div/div/div/div/div/button').click()  # 1st button learn more
            time.sleep(5)
            ...
            ##time.sleep(5)
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located((By.XPATH,'//*[@id="root"]/div[2]/div/div[2]/div/button'))).click()  # more info button
            time.sleep(3)
            self.driver.close()
            ...
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located((By.XPATH, '//*[@id="HERO_CAROUSEL_CONTAINER"]/div/ul/li[5]/button'))).click()  # fifth button click
            time.sleep(5)
            self.driver.find_element(By.XPATH, '//*[@id="HERO_CAROUSEL_CONTAINER"]/div/div/div/div[6]/div/div/div/div/div/div/button').click()  # 5th button learn more
            time.sleep(5)
            ##WebDriverWait(self.driver, 60).until(ec.presence_of_element_located((By.XPATH, '//*[@id="HERO_CAROUSEL_CONTAINER"]/div/div/div/div[2]/div/div/div/div/div/div/button'))).click()  # springs pledge learn more
            ##self.driver.execute_script('arguments[0].scrollIntoView(true);', mif)  # Scroll Down to the Bottom
            ##time.sleep(5)
    ...
    def test_news_and_weather(self, onstream_version, onstream_url, client_setup):
        try:
            ...
            self.driver.find_element(By.XPATH, '//*[@id="SWIMLANE_INNER_CONTAINER_0"]/div[1]/div').click()  # left arrow
            time.sleep(3)
            self.driver.find_element(By.XPATH, '//*[@id="ITEM_SWIMLANE_INNER_CONTAINER_0_0"]/div/div[1]').click()  # first box
            time.sleep(4)
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div[2]/div/div[2]/div[2]/button').click()  # leaRN MORE
            time.sleep(4)
            self.driver.close()
            self.driver.switch_to.window(self.driver.window_handles[0]) # switch to previous tab
            self.driver.find_element(By.XPATH, '//*[@id="ITEM_SWIMLANE_INNER_CONTAINER_0_2"]/div/div[1]').click()  # third button click
            time.sleep(3)
            self.driver.find_element(By.XPATH,'//*[@id="root"]/div[2]/div/div[2]/div/button').click()  # third button learn more
            time.sleep(4)
            self.driver.close()
            self.driver.find_element(By.XPATH,'//*[@id="SWIMLANE_INNER_CONTAINER_0"]/div[1]/div').click()  # right arrow
            time.sleep(3)
            self.driver.find_element(By.XPATH,'//*[@id="SWIMLANE_INNER_CONTAINER_0"]/div[2]/div').click()  # right arrow
            time.sleep(3)
            self.driver.find_element(By.XPATH, '//*[@id="SWIMLANE_INNER_CONTAINER_0"]/div[2]/div').click()  # right arrow
            time.sleep(3)
            self.driver.find_element(By.XPATH,'//*[@id="SWIMLANE_INNER_CONTAINER_0"]/div[2]/div').click()  # right arrow
            ...
            ##self.driver.find_element(By.XPATH,'//*[@id="SWIMLANE_INNER_CONTAINER_0"]/div[2]/div').click()  # right arrow
            ##time.sleep(5)
            self.driver.find_element(By.XPATH,'//*[@id="ITEM_SWIMLANE_INNER_CONTAINER_0_4"]/div/div[1]').click()  # fifth button click play
            time.sleep(10)
    ...
    def test_community_information(self, onstream_version, onstream_url, client_setup):
        try:
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located((By.XPATH, UI_Constant.home_button)))  # Wait for the Home Page to Load
            time.sleep(5)
            self.driver.find_element(By.XPATH, '//*[@id="ITEM_SWIMLANE_INNER_CONTAINER_1_0"]/div/div[1]').click()  # widget 1
            time.sleep(5)
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div[2]/div/div[2]/div/button').click()  # More Info Button
            time.sleep(5)
            self.driver.close()
            time.sleep(5)
            self.driver.find_element(By.XPATH, '//*[@id="ITEM_SWIMLANE_INNER_CONTAINER_1_1"]/div').click()  # second widget
            time.sleep(5)
            self.driver.find_element(By.XPATH, '//*[@id="ITEM_SWIMLANE_INNER_CONTAINER_1_1_MODAL_BUTTON"]').click()  # More Info Button
            time.sleep(5)
            self.driver.close
            self.driver.find_element(By.XPATH, '//*[@id="ITEM_SWIMLANE_INNER_CONTAINER_1_2"]/div').click()  # sports
            time.sleep(3)
            self.driver.find_element(By.XPATH, '//*[@id="SWIMLANE_INNER_CONTAINER_0"]/div[1]/div').click()  # right arrow
            time.sleep(3)
            self.driver.find_element(By.XPATH, '//*[@id="SWIMLANE_INNER_CONTAINER_0"]/div[1]/div').click()  # left arrow
            time.sleep(3)
            self.driver.find_element(By.XPATH, '//*[@id="ITEM_SWIMLANE_INNER_CONTAINER_0_0"]/div').click()  # play mlb click
            time.sleep(3)
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div[2]/div/div[1]/img').click()  # x close casue doesnt work
            time.sleep(3)
            self.driver.find_element(By.XPATH, '//*[@id="HEADER_CONTAINER"]/div[2]/nav/div/button[1]').click()  # home button
            time.sleep(3)
            self.driver.find_element(By.XPATH, '//*[@id="SWIMLANE_INNER_CONTAINER_1"]/div[1]/div').click()  # right arrow
            time.sleep(3)
            self.driver.find_element(By.XPATH, '//*[@id="ITEM_SWIMLANE_INNER_CONTAINER_1_3"]/div').click()  # weather
            time.sleep(3)
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div[2]/div/div[1]/img').click()  # weather x
            time.sleep(3)
            self.driver.find_element(By.XPATH,'//*[@id="SWIMLANE_INNER_CONTAINER_1"]/div[2]/div').click()  # right arrow
            time.sleep(10)
            self.driver.find_element(By.XPATH,'//*[@id="ITEM_SWIMLANE_INNER_CONTAINER_1_4"]/div/div[1]').click()  #advert
            time.sleep(3)
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div[2]/div/div[2]/div/button').click()  # learn more
            time.sleep(5)
            self.driver.close()
            time.sleep(10)
            self.driver.find_element(By.XPATH, '//*[@id="SWIMLANE_INNER_CONTAINER_1"]/div[2]/div').click()  # right arrow
            time.sleep(10)
            self.driver.close()
            self.driver.find_element(By.XPATH,'//*[@id="ITEM_SWIMLANE_INNER_CONTAINER_1_5"]/div').click()  # tornado warning
            time.sleep(3)
            self.driver.find_element(By.XPATH, '//*[@id="ITEM_SWIMLANE_INNER_CONTAINER_1_5_MODAL_BUTTON"]').click()  # more info
            time.sleep(5)
            self.driver.close()
            '''self.driver.find_element(By.XPATH,'//*[@id="ITEM_SWIMLANE_INNER_CONTAINER_1_0"]/div/div[1]').click()  # widget 1
            time.sleep(3)
...
class TestLiveTv:
    def test_modern_guide(self, onstream_version, onstream_url, client_setup):
        try:
            ...
            time.sleep(3)
            ##self.driver.find_element(By.XPATH,UI_Constant.settings_button).click()  #Settings button
            self.driver.find_element(By.XPATH, '//*[@id="HEADER_CONTAINER"]/div[2]/nav/div/button[4]').click()  # settings new
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located((By.XPATH, UI_Constant.guide_choice))).click()  # change guide style
            time.sleep(3)
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located((By.XPATH, UI_Constant.modern_guide))).click()  # modern guide
            time.sleep(3)
            ...
            for i in range(len(play_buttons)):
                ...
                time.sleep(15)
                self.driver.find_element(By.XPATH, '//*[@id="root"]/button/div').click()  # click play on safari
                ##self.driver.find_element(By.XPATH, '//*[@id="root"]/div/div/div[1]/div[2]/div/div/div/div/div/div[1]/div/div[2]/div/div/div[1]/div/div[2]/div/div/div[2]/div/div/div[1]/div/div').click()  # click play on safari testing
                time.sleep(15)
                self.driver.find_element(By.XPATH,
                ...
                time.sleep(10)
                WebDriverWait(self.driver, 60).until(
                    ec.presence_of_element_located((By.XPATH, UI_Constant.down_arrow))).click()  # down arrow
                time.sleep(5)
                ##WebDriverWait(self.driver, 60).until(ec.presence_of_element_located((By.XPATH, UI_Constant.up_arrow))).click() #up arrow
                time.sleep(5)
                WebDriverWait(self.driver, 60).until(
                    ec.presence_of_element_located((By.XPATH, UI_Constant.right_arrow))).click() # right arrow
                time.sleep(5)
                WebDriverWait(self.driver, 60).until(
                    ec.presence_of_element_located((By.XPATH, UI_Constant.left_arrow))).click() # left arrow
                time.sleep(5)
    ...
    def test_classic_guide(self, onstream_version, onstream_url, client_setup):
        try:
            ...
            for i in range(len(play_buttons)):
                ...
                time.sleep(5)
                WebDriverWait(self.driver, 60).until(
                    ec.presence_of_element_located((By.XPATH, UI_Constant.up_arrow))).click() #up
                time.sleep(5)
                WebDriverWait(self.driver, 60).until(
